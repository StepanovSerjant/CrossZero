...
<p>Данная игра имеет адаптивный дизайн, а также демонстрирует чей в данный момент времени ход. Результат партии отображается в появляющемся модальном окне, которое предоставляет информацию о победителе и дает возможность начать игру заново, обновив игровое поле.</p>
